...
class Area():
    ...
    def outline(self, frame_color, thichness):
        pygame.draw.rect(main_window, frame_color, self.rect, thichness)

#створюємо 4 картки, використовуючи Клас Area
...
#Створюємо класс спадкоємець для тексту і змоги його малювати 
class Label(Area):
